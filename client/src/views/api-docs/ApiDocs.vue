...
const apiGroups = reactive([
  ...
  },
  {
    ...
    label: '库存',
    apis: [
      { method: 'GET', path: '/stock/products', description: '物品列表', expanded: false, params: 'category, location, expiring' },
      { method: 'POST', path: '/stock/products', description: '创建物品', expanded: false, body: '{\n  "name": "牛奶",\n  "type": "food",\n  "quantity": 1,\n  "unit": "盒"\n}' },
      { method: 'GET', path: '/stock/products/:id', description: '物品详情' },
      { method: 'PUT', path: '/stock/products/:id', description: '更新物品' },
      { method: 'DELETE', path: '/stock/products/:id', description: '删除物品' },
      { method: 'POST', path: '/stock/products/:id/consume', description: '消耗物品', expanded: false, body: '{\n  "quantity": 1,\n  "note": "早餐喝了"\n}' },
      { method: 'POST', path: '/stock/products/:id/transfer', description: '转移位置' },
      { method: 'POST', path: '/stock/products/:id/adjust', description: '调整数量' },
